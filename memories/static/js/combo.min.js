"use strict";(function(){var userAgent=navigator.userAgent.toLowerCase(),initialDate=new Date(),$document=$(document),$window=$(window),$html=$("html"),$body=$("body"),isDesktop=$html.hasClass("desktop"),isIE=userAgent.indexOf("msie")!==-1?parseInt(userAgent.split("msie")[1],10):userAgent.indexOf("trident")!==-1?11:userAgent.indexOf("edge")!==-1?12:!1,isMobile=/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent),windowReady=!1,isNoviBuilder=!1,loaderTimeoutId,plugins={bootstrapTooltip:$("[data-toggle='tooltip']"),bootstrapModalDialog:$('.modal'),bootstrapTabs:$(".tabs-custom"),customToggle:$("[data-custom-toggle]"),counter:$(".counter"),captcha:$('.recaptcha'),campaignMonitor:$('.campaign-mailform'),copyrightYear:$(".copyright-year"),checkbox:$("input[type='checkbox']"),isotope:$(".isotope"),layoutToggle:$(".layout-toggle"),lightGallery:$("[data-lightgallery='group']"),lightGalleryItem:$("[data-lightgallery='item']"),lightDynamicGalleryItem:$("[data-lightgallery='dynamic']"),maps:$('.google-map-container'),mailchimp:$('.mailchimp-mailform'),mfpGallery:$('[data-lightbox^="gallery"]'),owl:$(".owl-carousel"),popover:$('[data-toggle="popover"]'),progressLinear:$(".progress-linear"),preloader:$(".preloader"),rdNavbar:$(".rd-navbar"),rdMailForm:$(".rd-mailform"),rdInputLabel:$(".form-label"),regula:$("[data-constraints]"),radio:$("input[type='radio']"),swiper:$(".swiper-slider"),search:$(".rd-search"),searchResults:$('.rd-search-results'),statefulButton:$('.btn-stateful'),scroller:$(".scroll-wrap"),viewAnimate:$('.view-animate'),wow:$(".wow"),countdown:document.querySelectorAll('.countdown')};function isScrolledIntoView(elem){if(isNoviBuilder)return!0;return elem.offset().top+elem.outerHeight()>=$window.scrollTop()&&elem.offset().top<=$window.scrollTop()+$window.height()}
...
$('a[href="#"]').on('click',function(){if($(this).data('target')){}else{$('.rd-nav-item').removeClass('active').first().addClass('active')}})
...
if(plugins.maps.length){lazyInit(plugins.maps,initMaps)}})}());$(window).load(function(){var $div=$('<div/>',{'class':'iframe-container',html:'<iframe width="560" height="315" src="https://www.youtube.com/embed/IwnsR8EAbKg?modestbranding=1&rel=0" frameborder="0" allow="accelerometer; autoplay=1; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'});$('.jp-test44').replaceWith($div)});$(window).load(function(){var $div=$('<div/>',{'class':'iframe-container',html:'<iframe width="560" height="315" src="https://www.youtube.com/embed/JOQrgF52KfI?modestbranding=1&rel=0" frameborder="0" allow="accelerometer; autoplay=1; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'});$('.jp-test45').replaceWith($div)});$(window).load(function(){var $div=$('<div/>',{'class':'iframe-container',html:'<iframe width="560" height="315" src="https://www.youtube.com/embed/aye2hbx1jNM?modestbranding=1&rel=0" frameborder="0" allow="accelerometer; autoplay=1; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>'});$('.jp-test46').replaceWith($div)});$(window).load(function(){var $div=$('<div/>',{'class':'rd-navbar-brand ',html:'<a class="brand" href="#"><img class="brand-logo-dark" src="/static/images/WingWarpIcon-48x48.png" alt="" width="48" height="48"/></a>'});$('.jp-replace-icon-1').replaceWith($div)})